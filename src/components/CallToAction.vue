      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
        <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
          ...
          <div class="mt-10 flex">
            <a href="#" class="rounded-md bg-laGreen px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-laGreenLight focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-laGreen">Join our team <span aria-hidden="true">&rarr;</span></a>
          </div>
        </div>
